...
#define CMD_BUTTON_START_THREAD_INC 1003
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE:
        ...
        CreateWindowW(L"Button", L"ThreadInc", WS_CHILD | WS_VISIBLE, 10, 70, 75, 23, hWnd, (HMENU)CMD_BUTTON_START_THREAD_INC, hInst, 0);
        break;
    case WM_COMMAND:
        {
            ...
            case CMD_BUTTON_START_THREAD2:
                StartThread2();
                break;
            case CMD_BUTTON_START_THREAD_INC:
                StartThreadInc();
                break;
            case IDM_ABOUT:
...
DWORD WINAPI ThreadProcInc(LPVOID params) {
    int res = MessageBoxW(NULL, L"Thread", (WCHAR*)params, MB_OK);
    if (res == IDOK) {
...
void StartThreadInc()
{
    CreateThread(
        NULL,
        0,      //stack limit
        ThreadProcInc,    //adress of threar function
        ThreadInc, //pointers to paramentr(s)
        0,  //Creation flags 
        NULL //Thread Id Pointer
    );
}
